...
| **[Safaa AI](https://github.com/RamiDevX/Safaa-AI)** | 🎵 AI-powered Telegram bot that isolates vocals from music using Demucs. Supports YouTube links & MP3 uploads | `Python` `Aiogram` `Demucs` `PyTorch` |
